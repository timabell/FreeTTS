 ...
 */
public class MbrolaVoiceUS3 extends MbrolaVoice {
        
    /**
     * Creates a simple voice
     */
    public MbrolaVoiceUS3() {
	this(false);
    }
     ...
     */
    public MbrolaVoiceUS3(boolean createLexicon) {
	super(createLexicon);
	setRate(150f);
	setPitch(125F);
	setPitchRange(12F);
    ...
    protected UtteranceProcessor getUnitConcatenator() throws IOException {
        ...
        String mbrolaVoiceDB = mbrolaBase + File.separator + "us3" +
            File.separator + "us3";
