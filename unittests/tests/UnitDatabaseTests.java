...
public class UnitDatabaseTests extends TestCase {
	...
	private final static String BINARY_DB = "file:../bld/classes/com/sun/speech/freetts/en/us/cmu_us_kal/cmu_us_kal.bin";
	private final static String TEXT_DB = "file:../com/sun/speech/freetts/en/us/cmu_us_kal/cmu_us_kal.txt";
	...
	protected void setUp() {
		try {
			udb = new DiphoneUnitDatabase(new URL(BINARY_DB), true);
		} catch (IOException ioe) {
			System.out.println("Can't load db " + ioe);
		}
	}

	/** Checks to make sure that the binary and text version of the DB compare. */
	public void testIdentical() {
		DiphoneUnitDatabase udbTextVersion = null;
		try {
			udbTextVersion = new DiphoneUnitDatabase(new URL(TEXT_DB), false);
