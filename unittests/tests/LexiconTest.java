...
public class LexiconTest extends TestCase {
	...
	protected void setUp() {
		try {
			...
			final InputStream in = LexiconTest.class.getResourceAsStream("LEX.txt");
	...
	public void testLexicon() {
		...
		try {
			while ((line = reader.readLine()) != null) {
				...
				assertTrue("Phones returned for " + word + pos + " is not null: ", lex_phone_array != null);
				...
				lex_phones.append(")");
				assertTrue("Phones returned for " + word + pos + " are identical " + "(Our phones: " + lex_phones + ", "
						+ "Flite phones: " + flite_phones + "): ", flite_phones.equals(lex_phones.toString()));
			}
		} catch (IOException e) {
