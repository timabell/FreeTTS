...
public class RtpServer {
	/** Audio format. */
	public static final AudioFormat FORMAT_ULAR_RTP = new AudioFormat(AudioFormat.ULAW_RTP, 8000d, 8, 1,
	...
	/** Constructs a new object taking a free random port and this computer as the local address.
	 * @throws IOException
	 * @throws SessionManagerException
	 * @throws MediaException */
	public RtpServer() throws IOException, SessionManagerException, MediaException {
	 ...
	 * @throws SessionManagerException
	 * @throws MediaException */
	public RtpServer(int localPort) throws IOException, SessionManagerException, MediaException {
	 ...
	 * @throws IOException
	 * @throws SessionManagerException */
	public void addTarget(int remotePort) throws IOException, SessionManagerException {
