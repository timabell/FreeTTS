...
/** Implements the AudioPlayer for the freetts Client/Server demo. This SocketAudioPlayer basically sends synthesized
 * wave bytes to the client. */
public class SocketAudioPlayer implements AudioPlayer {
	...
	/** Constructs a SocketAudioPlayer that will send wave bytes to the given Socket.
	...
	/** Pauses all audio output on this player. Play can be resumed with a call to resume. Not implemented in this Player. */
	public void pause() {
	}
	...
	/** Signals the end of a set of data. Audio data for a single utterance should be groupd between
	 * <code> begin/end </code> pairs.
	 * @return <code>true</code> if the audio was output properly, <code> false</code> if the output was cancelled or
	 * interrupted. */
	public boolean end() {
		if (debug) {
	...
	/** Cancels all queued output. All 'write' calls until the next reset will return false. Not implemented in this
	 * Player. */
	public void cancel() {
	}

	/** Waits for all audio playback to stop, and closes this AudioPlayer. Not implemented in this Player. */
	public void close() {
	}

	/** Returns the current volume. The volume is specified as a number between 0.0 and 1.0, where 1.0 is the maximum
	 * volume and 0.0 is the minimum volume. Not implemented in this Player.
	 ...
	 * and 0.0 is the minimum volume. Not implemented in this Player.
	 * @param volume the new volume (between 0 and 1) */
	public void setVolume(float volume) {
	}

	/** Gets the amount of audio played since the last resetTime. Not implemented in this Player.
	...
	/** Returns the first byte sent time in milliseconds, the last time it was recorded.
