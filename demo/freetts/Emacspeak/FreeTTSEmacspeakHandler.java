...
public class FreeTTSEmacspeakHandler extends EmacspeakProtocolHandler {
	...
	/** This thread is used to separate the handling of Voice.speak() from the thread that accepts commands from the
	 * client, so that the latter won't be blocked by the former. */
