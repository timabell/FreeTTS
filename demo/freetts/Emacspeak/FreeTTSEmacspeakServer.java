...
public class FreeTTSEmacspeakServer extends TTSServer {
	...
	/** Spawns a ProtocolHandler depending on the current protocol. This method is inherited from TTSServer.
	 * @param socket the socket that the spawned protocol handler will use */
	protected void spawnProtocolHandler(Socket socket) {
		try {
			FreeTTSEmacspeakHandler handler = new FreeTTSEmacspeakHandler(socket, emacsVoice);
	...
	/** Starts this TTS Server. Usage: FreeTTSEmacspeakServer [voicename [speaking rate]] */
