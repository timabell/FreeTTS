...
public class SingleFileAudioPlayer implements AudioPlayer {
	 ...
	 * "com.sun.speech.freetts.AudioPlayer.baseName" property for the base filename to use, and will produce a file of the
	 * form &lt;baseName>.wav. The default value for the base name is "freetts". */
