...
/** Provides an implementation of <code>AudioPlayer</code> that sends all audio data to the given file. */
public class RawFileAudioPlayer implements AudioPlayer {
	 ...
	 * form &lt;baseName>.raw. The default value for the base name is "freetts". */
	 ...
	 * @return <code>true</code> if the audio played to completion, <code> false </code>if the audio was stopped */
