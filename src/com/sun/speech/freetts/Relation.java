...
/** Represents an ordered set of {@link Item}s and their associated children. A relation has a name and a list of items,
 * and is added to an {@link Utterance} via an {@link UtteranceProcessor}. */
public class Relation implements Dumpable {
	...
	/** Name of the relation that contains tokens from the original input text. This is the first thing to be added to the
	 * utterance.
	 * @see #WORD */
	...
	/** Name of the relation that contains the ordered list of the smallest units of speech (typically phonemes) for the
	 * entire utterance.
	 * @see #SYLLABLE
	...
	/** Name of the relation that contains the description of the syllables for the Utterance. This is typically added to
	 * the utterance at the same time as the <code>Segment</code> and <code>SylStructure</code> relations.
	 * @see #SEGMENT
	 * @see #SYLLABLE_STRUCTURE
	 * @see Segmenter */
	...
	/** Name of the relation that maps fundamental frequency targets to absolute times for wave to be generated from the
	 * utterance. */
	public static final String TARGET = "Target";

	/** Name of the relation that contains the ordered list of the units from the unit database that will be used to create
