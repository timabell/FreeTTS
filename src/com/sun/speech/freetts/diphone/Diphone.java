...
/** Represents two adjacent phones. A diphone is defined by its name, the set of audio data, and information used to help
 * stitch diphones together. This class is immutable. */
public class Diphone {
	...
	/** Determines if the two diphones are equivalent. This is for testing databases. This is not the same as "equals"
