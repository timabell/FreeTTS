...
/** Describes global sample parameters. A sample info is generally added to an utterance to describe the type of unit
...
public class SampleInfo {
	...
	public SampleInfo(int sampleRate, int numberOfChannels, int residualFold, float coeffMin, float coeffRange,
			float postEmphasis) {
