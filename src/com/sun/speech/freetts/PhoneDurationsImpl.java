 ...
 * </pre>
 * 
 * Where <code>phone</code> is the phone name, <code>mean</code> is a <code>float</code> representing the mean duration
 * of the phone (typically in seconds), and <code>stddev</code> is a <code>float</code> representing the standard
