...
/** Represents the abstract interface to an entity that has a set of features. Provides interfaces to set and get the
 * name/value pairs as well as providing a set of convenience methods for setting and retrieving values of a particular
 * type. */
