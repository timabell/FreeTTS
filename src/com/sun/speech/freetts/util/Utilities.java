...
public class Utilities {
	 ...
	 * @param defaultValue the default value to use if the property cannot be found.
	 * @return the string value for the property, or the defaultValue if the property cannot be found */
	 ...
	 * @param name the name of the property
	 * @return If there is no property with the specified name, or if the specified name is empty or null, then false is
	 * returned. otherwise the boolean value of the property is returned */
	 ...
	 * @param name the name of the property
	 * @param defaultValue the default value to use if the property cannot be found.
	 * @return the long value for the property, or the defaultValue if the property cannot be found */
	 ...
	 * @param name the name of the property
	 * @param defaultValue the default value to use if the property cannot be found.
	 * @return the Integer value for the property, or the defaultValue if the property cannot be found */
