...
public class Timer {
	...
	/** Shows detailed timing stats. If overall is non-zero, it represents the overall processing time and a percentage of
	 * overall time for this timer should be calculated and displayed.
	 ...
	 * @param title shows the title and column headings for the time display */
	...
	/** Shows brief timing stats. If overall is non-zero, it represents the overall processing time and a percentage of
	 * overall time for this timer should be calculated and displayed.
	 * @param overall the overall processing time in milliseconds or 0. */
	...
	/** Shows timing stats. If overall is non-zero, it represents the overall processing time and a percentage of overall
