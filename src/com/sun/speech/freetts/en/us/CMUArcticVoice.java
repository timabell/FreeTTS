	...
	public UtteranceProcessor getUnitSelector() throws IOException {
		ClusterUnitNamer unitNamer = new ClusterUnitNamer() {
			public void setUnitName(Item seg) {
				...
				/* If we have a vowel, then the unit name is the segment name plus a 0 or 1, depending upon the stress of the
				 * parent. Otherwise, the unit name is the segment name plus "coda" or "onset" based upon the seg_onsetcoda
				 * feature processor. */
