...
/** Expands Strings containing digits characters into a list of words representing those digits. It translates the
 * following code from flite: <code>lang/usEnglish/us_expand.c</code> */
public class NumberExpander {

	private static final String[] digit2num = { "zero", "one", "two", "three", "four", "five", "six", "seven", "eight",
			"nine" };
	...
	private static final String[] ord2num = { "zeroth", "first", "second", "third", "fourth", "fifth", "sixth",
	...
	/** Expands a digit string into a list of English words of those digits. For example, "1234" expands to
	 * "one two three four"
	...
	/** Expands a string that is a 4 to 6 digits number into a list of English words. For example, "333000" into "three
	...
	/** Expands a string that is a number longer than 3 digits into a list of English words. For example, "1000" into one
	 * thousand.
	 * @param numberString the string which is the number to expand
	 * @param order either "thousand", "million", or "billion"
	 * @param numberZeroes the number of zeroes, depending on the order, so its either 3, 6, or 9
	 * @param wordRelation words are added to this Relation */
	...
	/** Returns the number string list of the given string starting at the given index. E.g., expandNumberAt("1100", 1)
	 * gives "one hundred"
	 * @param numberString the string which is the number to expand
	...
	/** Finds a match of the given string in the given array, and returns the element at the same index in the
	 * returnInArray
