...
/** Implements a finite state machine that checks if a given string is pronounceable. If it is pronounceable, the method
...
public class PronounceableFSM {
	 ...
	 * @param scanFromFront indicates whether this FSM should scan the input string from the front, or from the back */
