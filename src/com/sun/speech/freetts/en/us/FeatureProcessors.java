...
public class FeatureProcessors {
	...
	private final static PathExtractor FIRST_SYLLABLE_PATH = new PathExtractorImpl(
			"R:SylStructure.parent.R:Phrase.parent.daughter.R:SylStructure.daughter", false);

	private final static PathExtractor LAST_SYLLABLE_PATH = new PathExtractorImpl(
			"R:SylStructure.parent.R:Phrase.parent.daughtern.R:SylStructure.daughter", false);

	private final static PathExtractor LAST_LAST_SYLLABLE_PATH = new PathExtractorImpl(
			"R:SylStructure.parent.R:Phrase.parent.daughtern.R:SylStructure.daughtern", false);

	private final static PathExtractor SUB_PHRASE_PATH = new PathExtractorImpl("R:SylStructure.parent.R:Phrase.parent.p",
			false);
	...
	/** Returns a guess of the part-of-speech. This is a feature processor. A feature processor takes an item, performs
	...
	/** Returns as an Integer the number of syllables in the given word. This is a feature processor. A feature processor
	...
	/** Counts the number of accented syllables since the last major break. This is a feature processor. A feature
	 * processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Counts the number of stressed syllables since the last major break. This is a feature processor. A feature
	 * processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Counts the number of stressed syllables until the next major break. This is a feature processor. A feature
	 * processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Returns the length of the string. (generally this is a digit string) This is a feature processor. A feature
	 * processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Returns true ("1") if the given item is a number between 0 and 32 exclusive, otherwise, returns "0". string) This
	 * is a feature processor. A feature processor takes an item, performs some sort of processing on the item and returns
	 * an object. */
	public static class MonthRange implements FeatureProcessor {

		/** Performs some processing on the given item.
		 * @param item the item to process
		 * @return returns "1" if the given item is a number between 0 and 32 (exclusive) otherwise returns "0"
		 * @throws ProcessException if an exception occurred during the processing */
		public String process(Item item) throws ProcessException {
	...
	/** Attempts to guess the part of speech. This is a feature processor. A feature processor takes an item, performs some
	...
	/** Checks to see if the given syllable is accented. This is a feature processor. A feature processor takes an item,
	...
	/** Find the last accented syllable This is a feature processor. A feature processor takes an item, performs some sort
	...
	/** Finds the position of the phoneme in the syllable This is a feature processor. A feature processor takes an item,
	 * performs some sort of processing on the item and returns an object. */
	...
	/** Classifies the the syllable as single, initial, mid or final. This is a feature processor. A feature processor
	 * takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Determines the break level after this syllable This is a feature processor. A feature processor takes an item,
	 * performs some sort of processing on the item and returns an object. */
	...
	/** Determines the word break. This is a feature processor. A feature processor takes an item, performs some sort of
	...
	/** Determines the word punctuation. This is a feature processor. A feature processor takes an item, performs some sort
	 * of processing on the item and returns an object. */
	 ...
	 * A feature processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Return consonant type s-stop f-fricative a-affricative n-nasal * l-liquid This is a feature processor. A feature
	 * processor takes an item, performs some sort of processing on the item and returns an object. */
	...
	/** Return consonant voicing +=on -=off This is a feature processor. A feature processor takes an item, performs some
	 * sort of processing on the item and returns an object. */
	...
	/** Return vowel or consonant +=on -=off This is a feature processor. A feature processor takes an item, performs some
	 * sort of processing on the item and returns an object. */
	...
	/** Return vowel frontness 1-front 2-mid 3-back This is a feature processor. A feature processor takes an item,
	 * performs some sort of processing on the item and returns an object. */
	...
	/** Return vowel height 1-high 2-mid 3-low This is a feature processor. A feature processor takes an item, performs
	 * some sort of processing on the item and returns an object. */
	...
	/** Return vowel length s-short l-long d-dipthong a-schwa This is a feature processor. A feature processor takes an
	...
	/** Return vowel rnd (lip rounding) lip rounding +=on -=off This is a feature processor. A feature processor takes an
	 * item, performs some sort of processing on the item and returns an object. */
	...
	/** Determines the onset size of this syllable This is a feature processor. A feature processor takes an item, performs
	 * some sort of processing on the item and returns an object. */
	...
	/** Determines the coda size This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for fricative This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for coda stop This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for onset stop This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for coda nasal This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for onset nasal This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for coda glide This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for onset glide This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Checks for onset coda This is a feature processor. A feature processor takes an item, performs some sort of
	 * processing on the item and returns an object. */
	...
	/** Counts the number of phrases before this one. This is a feature processor. A feature processor takes an item,
	 * performs some sort of processing on the item and returns an object. */
	...
	/** Returns the duration of the given segment This is a feature processor. A feature processor takes an item, performs
	 * some sort of processing on the item and returns an object. */
	public static class SegmentDuration implements FeatureProcessor {
		...
		public String process(Item seg) throws ProcessException {
			if (seg == null) {
				...
				return Float.toString(seg.getFeatures().getFloat("end") - seg.getPrevious().getFeatures().getFloat("end"));
			}
		}
	}
	 ...
	 * @return <code>true</code> if the item is accented, otherwise <code>false</code> */
	private static boolean isAccented(Item item) {
		return (item.getFeatures().isPresent("accent") || item.getFeatures().isPresent("endtone"));
	}

	/** Rails an int. flite never returns an int more than 19 from a feature processor, we duplicate that behavior here so
	 * that our tests will match.
