...
public class CMUDiphoneVoice extends CMUVoice implements ConcatenativeVoice {
	...
	/** Creates a simple voice. This is merely for backwards compatibility with versions of FreeTTS earlier than v1.2
	...
	public CMUDiphoneVoice(String name, Gender gender, Age age, String description, Locale locale, String domain,
	...
	public URL getDatabase() {
		if (database == null) {
			/* This is merely for backwards compatibility with versions of FreeTTS earlier than v1.2 (i.e., before the voice
	...
	/** Returns the post lexical processor to be used by this voice. Derived voices typically override this to customize
	 * behaviors.
	...
	/** Returns the pitch mark generator to be used by this voice. Derived voices typically override this to customize
	 * behaviors. This voice uses a DiphonePitchMark generator to generate pitchmarks.
	...
	/** Returns the unit concatenator to be used by this voice. Derived voices typically override this to customize
	 * behaviors. This voice uses a relp.UnitConcatenator to concatenate units.
	 ...
	 * This voice uses the DiphoneUnitSelector to select units. The unit selector requires the name of a diphone database.
	 * If no diphone database has been specified then an Error is thrown.
...
/** Annotates the utterance with post lexical information. Converts AH phonemes to AA phoneme in addition to the standard
 * english postlex processing. */
class CMUDiphoneVoicePostLexicalAnalyzer implements UtteranceProcessor {
	...
	/** Turns all AH phonemes into AA phonemes. This should really be done in the index itself
