...
/** Converts the Tokens (in US English words) in an Utterance into a list of words. It puts the produced list back into
 * the Utterance. Usually, the tokens that gets expanded are numbers like "23" (to "twenty" "three").
 * <p>
...
public class TokenToWords implements UtteranceProcessor {
	...
	// King-like words
	private static final String[] kingNames = { "louis", "henry", "charles", "philip", "george", "edward", "pius",
			"william", "richard", "ptolemy", "john", "paul", "peter", "nicholas", "frederick", "james", "alfonso", "ivan",
			"napoleon", "leo", "gregory", "catherine", "alexandria", "pierre", "elizabeth", "mary" };

	private static final String[] kingTitles = { "king", "queen", "pope", "duke", "tsar", "emperor", "shah", "caesar",
			"duchess", "tsarina", "empress", "baron", "baroness", "sultan", "count", "countess" };

	// Section-like words
	private static final String[] sectionTypes = { "section", "chapter", "part", "phrase", "verse", "scene", "act",
			"book", "volume", "chap", "war", "apollo", "trek", "fortran" };

	/** Here we use a hashtable for constant time matching, instead of using if (A.equals(B) || A.equals(C) || ...) to
	 * match Strings */
	...
	private static final String[][] usStates = { { "AL", "ambiguous", "alabama" }, { "Al", "ambiguous", "alabama" },
			...
			{ "Lou", "ambiguous", "louisiana" }, { "Lous", "ambiguous", "louisiana" },
			{ "MA", "ambiguous", "massachusetts" }, { "Mass", "ambiguous", "massachusetts" },
			{ "Ma", "ambiguous", "massachusetts" }, { "MD", "ambiguous", "maryland" }, { "Md", "ambiguous", "maryland" },
			{ "ME", "ambiguous", "maine" }, { "Me", "ambiguous", "maine" }, { "MI", "", "michigan" },
			{ "Mi", "ambiguous", "michigan" }, { "Mich", "ambiguous", "michigan" }, { "MN", "ambiguous", "minnestota" },
			{ "Minn", "ambiguous", "minnestota" }, { "MS", "ambiguous", "mississippi" },
			...
			{ "WI", "ambiguous", "wisconsin" }, { "Wi", "ambiguous", "wisconsin" },
			{ "WV", "ambiguous", "west", "virginia" }, { "WY", "ambiguous", "wyoming" }, { "Wy", "ambiguous", "wyoming" },
	 ...
	 * @param tokenVal the String value of the token, which may or may not be same as the one in called "name" in flite */
	...
	/** Returns true if the given key is in the kingSectionLikeHash Hashtable, and the value is the same as the given
	 * value.
	...
	/** Returns true if the given token is the name of a US state. If it is, it will add the name of the state to (word)
	...
	/** Determines if the character at the given position of the given input text is splittable. A character is splittable
	 * if:
	 * <p>
