...
/** This voice directory provides a default US/English Cluster Unit voice imported from CMU Flite. */
public class AlanVoiceDirectory extends VoiceDirectory {
	...
	public Voice[] getVoices() {
		...
		Voice alan = new CMUClusterUnitVoice("alan", Gender.MALE, Age.YOUNGER_ADULT,
				"default time-domain cluster unit voice", Locale.US, "time", "cmu", lexicon, this.getClass().getResource(
						"cmu_time_awb.bin"));
		Voice[] voices = { alan };
		return voices;
	}
