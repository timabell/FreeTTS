...
public interface FreeTTSSpeakable {
	...
	/** Returns <code>true</code> if this queue item has been processed.
	 * @return true if it has been processed */
	public boolean isCompleted();

	/** Waits for this speakable item to be completed.
	 * @return true if the item was completed successfully, false if the speakable was cancelled or an error occurred. */
	public boolean waitCompleted();

	/** Returns <code>true</code> if the item contains plain text (not Java Speech Markup Language text).
	...
	/** Returns <code>true</code> if the item is a JSML document (Java Speech Markup Language).
