...
public interface LetterToSound {
	/** Calculate the phone list for a given word. If a phone list cannot be determined, <code>null</code> is returned. The
	 * phone list is implementation dependent. The format of the <code>partOfSpeech</code> is also implementation. If the
