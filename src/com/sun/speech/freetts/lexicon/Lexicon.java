...
/** Provides the phone list for words. A Lexicon is composed of three pieces: an addenda, the compiled form, and the
 * letter to sound rules.
 * <ul>
 * <li>The addenda either contains Word instances that are not in the compiled form, or it contains Word instances that
 * replace definitions in the compiled form. The addenda is meant to be relatively small (e.g., 10's of words).
 * <li>The compiled form is meant to hold a large number of words (e.g., 10's of thousands of words) and provide a very
 * efficient means for finding those words.
 * <li>The letter to sound rules will attempt to find a definition for a word not found in either the addenda or
 * compiled form.
 * </ul> */
public interface Lexicon {
	...
	/** Determines if the <code>currentWordPhone</code> represents a new syllable boundary.
