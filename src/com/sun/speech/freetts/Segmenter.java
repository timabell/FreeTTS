 ...
 * <code>Relation.SEGMENT</code>. To determine stress, the <code>isStressed</code> method relies upon a phone ending in
 * the number "1". Subclasses should override <code>isStressed</code> and <code>deStress</code> if stresses are
...
public class Segmenter implements UtteranceProcessor {
	...
	/** Determines if the given phonemene is stressed. To determine stress, this method relies upon a phone ending in the
	 * number "1". Subclasses should override this method if stresses are determined in other ways.
	...
	/** Converts stressed phoneme to regular phoneme. This method merely removes the last character of the phone.
	 * Subclasses should override this if another method is to be used.
