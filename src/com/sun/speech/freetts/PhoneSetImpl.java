...
/** Implementation of a <code>PhoneSet</code> that reads the info from a file. The format of the file is as follows:
 * 
 * <pre>
 * phone feature value
 * phone feature value
 ...
 * </pre>
 * 
 * Where <code>phone</code> is the phone name, <code>feature</code> is the phone feature such as "vc," "vlng,"
 * "vheight," and so on, and "value" is the value of the feature. There can be multiple lines for the same phone to
 * describe various features of that phone. */
public class PhoneSetImpl implements PhoneSet {
	...
	/** Create a new <code>PhoneSetImpl</code> by reading from the given URL.
	...
	/** Given a phoneme and a feature, returns the key that will obtain the value.
