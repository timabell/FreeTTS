...
public class Token {
	 ...
	 * @return the whitespace characters of this Token; null if this Token does not use whitespace characters */
	public String getWhitespace() {
		return whitespace;
	}

	/** Returns the prepunctuation characters of this Token.
	 * @return the prepunctuation characters of this Token; null if this Token does not use prepunctuation characters */
	public String getPrepunctuation() {
		return prepunctuation;
	}

	/** Returns the postpunctuation characters of this Token.
	 * @return the postpunctuation characters of this Token; null if this Token does not use postpunctuation characters */
