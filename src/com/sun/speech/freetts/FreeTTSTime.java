...
public class FreeTTSTime extends FreeTTS {
	...
	/** Starts interactive mode on the given FreeTTSTime. Reads text from the console and gives it to FreeTTSTime to speak.
	...
	/** Returns a phrase that conveys the minutes in relation to the hour.
	 * @param hour the hour of the time
	 * @param min the minute of the time
	 * @return a string phrase. */
	...
	/** Returns a phrase that conveys the hour in relation to the hour.
	 * @param hour the hour of the time
	 * @param min the minute of the time
	 * @return a string phrase. */
	 ...
	 * @return the time in string, null if the given time is not in the form HH:MM */
	...
	public static String timeToString(int hour, int min) {
		String theTime = "The time is now, " + timeApprox(hour, min) + " " + timeMin(hour, min) + " " + timeHour(hour, min)
				+ ", " + timeOfDay(hour, min) + ".";
		return theTime;
	}

	/** Speaks the given time. Time should be in the exact form HH:MM where HH is the hour 00 to 23, and MM is the minute
	 * 00 to 59.
	 * @param time the time in the form HH:MM
	 * @throws IllegalArgumentException if time is not in the form HH:MM */
